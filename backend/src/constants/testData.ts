...
export const chatOne: Chat = {
  ...
  messages: [
    {
      message: "Hey, where should we go for dinner tonight?",
      userId: "1",
      messageId: "1",
    },
    {
      message: "I'm craving sushi, how about a sushi place?",
      userId: "2",
      messageId: "2",
    },
    {
    ...
    {
      message: "Same! I’ve been craving Italian all week.",
      userId: "3",
      messageId: "13",
    },
    {
    ...
    {
      message: "Can't wait! See you all there.",
      userId: "3",
      messageId: "19",
    },
    { message: "All set! See you soon!", userId: "1", messageId: "20" },
  ],
  sentimentScores: [
    { score: 5, userId: "1" },
    { score: 7, userId: "2" },
...
export const chatTwo: Chat = {
  id: 112,
  messages: [
    { message: "David, I hate you.", userId: "2", messageId: "21" },
    { message: "What did I do?", userId: "3", messageId: "22" },
    {
      message: "You better have an idea on what did you do to her.",
      userId: "5",
      messageId: "23",
    },
    { message: "You cheated on me", userId: "2", messageId: "24" },
    { message: "This is not true.", userId: "3", messageId: "25" },
    {
      message: "I got evidence. I showed her the proof.",
      userId: "5",
      messageId: "26",
    },
    {
